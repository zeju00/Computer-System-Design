...
#define csd_BUTTON_ADDR	   0x41220000
...
#define GICD_ICFGR0		GICD_BASE   + 0xC00  // Interrupt Config. Register 0
#define GICD_ICFGR1		GICD_ICFGR0 + 0x4  // Interrupt Config. Register 1
#define GICD_ICFGR2		GICD_ICFGR0 + 0x8  // Interrupt Config. Register 2
#define GICD_ICFGR3		GICD_ICFGR0 + 0xC  // Interrupt Config. Register 3
...
#define GICD_ITARGET15	GICD_BASE + 0x800 + 4*15  //
...
#define GICD_PRIOR15	GICD_PRIOR0 + 4*15  // Interrupt Priority Register 15
